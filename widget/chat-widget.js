(()=>{(function(){"use strict";let h={websiteId:"default",apiUrl:"http://localhost:5000",title:"Website Assistant",welcomeMessage:"\u{1F44B} Hi! I can answer questions about this website. What would you like to know?",primaryColor:"#6c63ff",position:"bottom-right"},r=Object.assign({},h),I=`
  ...
  `,u=!1,y=!1,x=[],L=!1,v=!1,l,b,w,s,c,d,f,q,W,N,D,J;function B(e){r=Object.assign({},h,e),j(),H(),O(),m(r.welcomeMessage)}function j(){let e=document.createElement("style");e.textContent=I.replace(/var\(--cw-primary\)/g,r.primaryColor),document.head.appendChild(e)}function H(){let e=r.position==="bottom-left"?"bl":"br";l=o("button",`cw-launcher cw-launcher-${e}`),l.innerHTML=S(),l.setAttribute("aria-label","Open chat"),b=o("span","cw-badge"),b.textContent="1",b.style.display="none",l.appendChild(b),w=o("div",`cw-window cw-window-${e} cw-hidden`),w.setAttribute("role","dialog"),w.setAttribute("aria-label",r.title);let t=o("div","cw-header");t.innerHTML=`
    ...
    `;let n=o("button","cw-close-btn");n.innerHTML="\u2715",n.setAttribute("aria-label","Close chat"),n.onclick=k,t.querySelector(".cw-header-left").after(n),s=o("div","cw-messages"),s.setAttribute("aria-live","polite"),f=A(),f.style.display="none";let a=o("div","cw-input-row");c=o("textarea","cw-text-input"),c.placeholder="Ask me anything\u2026",c.rows=1,d=o("button","cw-send-btn"),d.innerHTML=F(),d.setAttribute("aria-label","Send"),a.append(c,d),w.append(t,s,f,a),document.body.append(l,w)}function A(){let e=o("div","cw-contact-form");return e.innerHTML=`
